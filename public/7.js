...
var Login = function Login() {
  ...
  var ShowPassChange = function ShowPassChange() {
    if (jquery__WEBPACK_IMPORTED_MODULE_3___default()("#ShowPass").prop("checked")) {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()("#Password").prop("type", "text");
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()("#Password").prop("type", "password");
    }
  };

  var Validator = function Validator(type, id) {
    if (type === "text") {
      if (jquery__WEBPACK_IMPORTED_MODULE_3___default()("#".concat(id)).val().trim() === "") {
        if (id === "Username") {
  ...
  var Login = function Login() {
    var Username = jquery__WEBPACK_IMPORTED_MODULE_3___default()("#Username").val();
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    fullWidth: true,
    onClick: Login
  }, "Login")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], {
    item: true,
    lg: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Button"], {
